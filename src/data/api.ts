...
export const ReservationApiFetchParamCreator = function (
  ...
  return {
     ...
     * @param {ReservationCreationRequest} reservation detailed information about the reservation
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    createReservation(
      reservation: ReservationCreationRequest,
      options: any = {},
    ): FetchArgs {
      ...
      if (reservation === null || reservation === undefined) {
        throw new RequiredError(
          'reservation',
          'Required parameter reservation was null or undefined when calling createReservation.',
        );
      }
  ...
  return {
    ...
    createReservation(
      ...
      const localVarFetchArgs = ReservationApiFetchParamCreator(
        configuration,
      ).createReservation(reservation, options);
      return (
        fetch: FetchAPI = portableFetch,
        basePath: string = BASE_PATH,
      ) => {
    ...
    putReservation(
      ...
      const localVarFetchArgs = ReservationApiFetchParamCreator(
        configuration,
      ).putReservation(id, confirmationToken, body, options);
      return (
        fetch: FetchAPI = portableFetch,
        basePath: string = BASE_PATH,
      ) => {
...
export const ReservationApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createReservation(reservation: ReservationCreationRequest, options?: any) {
      return ReservationApiFp(configuration).createReservation(
        reservation,
        options,
      )(fetch, basePath);
    },
